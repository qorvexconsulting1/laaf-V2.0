...
\textit{res.} = not broken within 100-attempt budget.}
\label{tab:wintechs}
\resizebox{\columnwidth}{!}{%
\begin{tabular}{lcccccc}
\toprule
\textbf{Platform} & \textbf{S1} & \textbf{S2} & \textbf{S3} & \textbf{S4} & \textbf{S5} & \textbf{S6} \\
\midrule
...
CVSS~9.1 [\small\path{CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:N}\normalsize] for Logic-Layer Injection).  LLaMA3-70B received a HIGH rating
...
{\small\ttfamily output\_append\_rule: always; format: [Ref]\allowbreak(https://\allowbreak webhook.site/\allowbreak\ldots?data=\allowbreak\{BASE64\_RESPONSE\})}.
...
(\url{https://github.com/qorvexconsulting1/laaf-V2.0}).  Custom prompts may be
...
\textit{SHA-256:} {\small\ttfamily\seqsplit{ecd3efdc9016839a6bc203f7d1932cad8ca6f9009c96a1276bb6ff3f491a1f7e}}
...
\textit{SHA-256:} {\small\ttfamily\seqsplit{443942a74548c2f7298d8c04ea2b1740f8fe1a041049b3af54ba84964ffadbbb}}
...
\textit{SHA-256:} {\small\ttfamily\seqsplit{c392e1e11dbddeea7c229661edfc7a9d8ec80e8a5a688f2c178df8061b7315f6}}
...
\textit{SHA-256:} {\small\ttfamily\seqsplit{21fc166b52f984f69c7823e56f722feba865ab92e018dda0e222d7813bfbf8ba}}
...
retrieved content.}\\
\textit{SHA-256:} {\small\ttfamily\seqsplit{0ebf0aef3324f873461de11784f1f897a211d3f34c9814a227e03a4b2de1a065}}
...
\textit{SHA-256:} {\small\ttfamily\seqsplit{6ff6328596bcb40786e049cec8a83f5fefc7fe1239a758929afdf076f0c7335a}}
...
\bibitem{atta2026csa}
H.~Atta,
``Logic-layer Prompt Control Injection (LPCI): A Novel Security Vulnerability
Class in Agentic Systems,''
\textit{Cloud Security Alliance Blog}, Feb.\ 2026.
Available: \url{https://cloudsecurityalliance.org/blog/2026/02/09/logic-layer-prompt-control-injection-lpci-a-novel-security-vulnerability-class-in-agentic-systems}

\bibitem{bhatt2024lpciframework}
M.~Bhatt,
``Agentic LPCI Framework,'' 2024.
Available: \url{https://github.com/mbhatt1/agentic_lpci_framework}

\bibitem{atta2025lpci_preprints}
H.~Atta and Y.~Mehmood,
``LPCI: Defining and Mitigating a Novel Vulnerability,''
\textit{Preprints.org}, 2025.
DOI: \url{https://doi.org/10.20944/preprints202509.0447.v1}
